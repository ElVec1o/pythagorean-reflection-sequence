...
it by (S1) and (S2). What remains is to prove the two asymptotic laws. Both live in the regime
$\tau=-\log q\to0$, where $w_m=\sqrt{2/\tau_m}\sim m\pi$, which is the regime the source's
Liouville--Green machinery is built for; we have not carried that analysis out.
