...
The two chains are moreover the same chain. With $D=\mathrm{diag}(q^{-1/4},q^{1/4})$, constant,
\[
   M^{\mathrm{bulk}}_b=D\,M^{\mathrm{travel}}_{b-1/2}\,D^{-1} ,
\]
an exact identity in $\Q(q^{1/4})$. This is the precise form of the statement that the zeros of
