...
generic $a$? A single faithful tuple answers this affirmatively. The arithmetic form, injectivity
at every Class C rational tuple, is Conjecture~\ref{conj:masterC}.
\end{problem}

\begin{conjecture}[Class C faithfulness]\label{conj:masterC}
$\rho_a$ is injective for every $a\in\Q_{>0}^n$ with $e(a)=t(a)=0$ and $n\ge3$.
\end{conjecture}
