...
Theorems~\ref{thm:family4} and \ref{thm:family4b} account for all $24$ failures among the $828$
primitive pairwise-distinct tuples with entries at most $8$, the first for the sixteen at depth
$8$ and the second for the eight at depth $12$. Each was frozen and then tested out of sample on
ten tuples outside that box, with ten of ten deviating at the predicted depth, and the first
against four controls off its locus, none of which deviates.
