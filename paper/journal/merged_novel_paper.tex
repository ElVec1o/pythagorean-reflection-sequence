...
anywhere. That is the form in which \textup{(S2)} should be attacked. We record the structure,
which is exact, and not any consequence for \textup{(S2)}, which we have not derived.
