...
\end{enumerate}
So Problem~\textup{\ref{prob:alternative}}, Problem~\textup{\ref{prob:embed}} and
Problem~\textup{\ref{prob:fp}} are not three questions in dimension $n$ but one, decided by
whether $U_n$ is trivial.
\end{theorem}
