...
numerators; the spectral and sign laws at the travel poles, conditional on a stated hypothesis
\textup{(T$^\ast_{\mathrm{poles}}$)}; an orthogonal arithmetic route through Christol's theorem;
...
({\cite[Corollary ``the travel poles are Hahn--Exton zeros'', \textup{cor:qbessel}]{Bonfioli2026bA}}), so Hypothesis~\ref{hyp:Tstar} and the note after it, with
...
$q$-dependent form domain; \textup{(I3)} {\cite[Proposition \textup{prop:qtrig}]{Bonfioli2026bA}} with
...
\textup{(I3)} is covered by {\cite[Proposition \textup{prop:qtrig}]{Bonfioli2026bA}}, {\cite[Theorem ``the travel determinant'', \textup{thm:fredholm}]{Bonfioli2026bA}} and
{\cite[Proposition ``infinitely many travel poles, without $T_2$'', \textup{prop:infpolesalt}]{Bonfioli2026bA}}, and Lemma~\ref{lem:infpoles} is not used; \textup{(I1)} is not used at all: it would turn the index
...
them: {\cite[Proposition ``the shape of the local form'', \textup{prop:shape}]{Bonfioli2026bA}} needs only $\pi\ge p\ge1$, and {\cite[Theorem ``closed form of the junction pairing'', \textup{thm:RJ}]{Bonfioli2026bA}} gives the
