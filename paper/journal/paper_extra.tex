...
What is not formalized is stated plainly in each file. The exclusion computations themselves,
being exact linear algebra over $43$ terms, are not re-run in Lean; neither is the passage
