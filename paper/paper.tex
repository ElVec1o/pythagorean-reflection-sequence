...
is the natural place a difference between shapes could appear, but
whether it affects the orbit counts $u_d$ is open.
...
the proof above and through depth $30$ by exact-rational BFS for the
shapes $(1,2)$ and $(3,4)$; we do not know whether it holds in general,
and we make no claim that it must hold or that it must fail.
\end{remark}
