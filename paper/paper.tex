...
--- so the collision structure they encode is $T$-independent.  We now
record precisely what this establishes about $u_d^T$, and separate it
cleanly from the all-depths statement, which remains a conjecture.
...
\begin{remark}[Status of the all-depths statement]
...
$> 22$.  We do not have a complete argument for this and state it
honestly as open.
\end{remark}
...
This is manifest from the Mayer--Vietoris identification, whose right-hand
