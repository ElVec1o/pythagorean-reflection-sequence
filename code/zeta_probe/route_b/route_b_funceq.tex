...
\item the full relaxed rate is $r=\lim v_{n+1}/v_n\in[\beta_2,\,{\approx}1.52]$
      with $r\ge\beta_2=1.4916177871\ldots$ rigorous (since relaxed length $\le$ true length;
      the squeeze $t_n\le u_n\le v_n$ later pins $r=\beta_2$ exactly, \S\ref{sec:transcendence}).
\end{itemize}
