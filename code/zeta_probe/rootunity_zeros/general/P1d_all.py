# P1d_all.py -- parameter search driver for P1d_cert.certify: for one seed p/q (side d>0), find (by bisection in log r)
...
from P1d_cert import certify, Fail, setup_x, find_t0, e, PI, I, aup
...
def trial(r, ef, ka, NP=6):
    ...
    try:
        B, Ns, Bs, rows = certify(p, q, r, n2, '%.6g' % eta, '%.6g' % V0, ka, NP, verbose=False, KSEG=32)
