...
\begin{itemize}
\item[(PROVED, computer-assisted)] Theorem~\texttt{thm:WT-lowcomplexity} (paper1, line 2565): for every
...
\item[(PROVED, conditional)] Theorem~\texttt{thm:WT-blowup} (paper1, line 2626): \emph{if} the universal
