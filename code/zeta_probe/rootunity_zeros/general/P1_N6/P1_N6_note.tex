...
from resonance as $\rho\to\infty$ along it. As currently proved, the ray lemma simply does not apply at
$N=6$'s own tie ray.} This is a genuinely different, and sharper, statement than ``$T<0$'': it says the
