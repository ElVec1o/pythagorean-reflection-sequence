# P1h_lowseed.py -- copy of ../P1e_lowseed.py with radii down to 1e-6 (P1h). low-height seeds for the middle-arc theorem (P1e_lemma.tex, Theorem M): rigorous Theorem-5-type certificate
...
T0 = time.time()
for r in (0.0083, 0.006, 0.004, 0.003, 0.002, 0.0015, 0.001, 7e-4, 5e-4, 3e-4, 2e-4, 1e-4, 5e-5, 2e-5, 1e-5, 5e-6, 2e-6, 1e-6):
    if r < RMIN: break
