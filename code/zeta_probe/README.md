...
| `route_b/` | The connectivity-lemma investigation: the deposit-family refutation of "bounded component count", the corrected per-component **strand** bound, and the 8-shape alphabet census. |
